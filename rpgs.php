...
<html>
    ...
    <body>        
            ...
            <ul id='navbar'>
                ...
                <li class="dropdown">Categories
                    <div class="dropdown-content">
                        ...
                        <a href='rpgs.php' id='current-page'>RPGs</a>
        ...
        <div id="page">
            <!-- IMAGE REFERENCE https://media.dnd.wizards.com/styles/news_banner_header/public/images/head-banner/bg-heroes_0.jpg-->
